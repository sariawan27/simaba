                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" id="stok-column" class="form-control" placeholder="Stok" name="stok">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" id="max-quantity-column" class="form-control" placeholder="Max. Quantity" name="max_quantity">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<script>
    $(document).ready(function() {
        $('#stok-column').change(function() {
            $('#stok-column').val($('#stok-column').val() < 1 ? 1 : $('#stok-column').val())
        })
        $('#max-quantity-column').change(function() {
            $('#max-quantity-column').val($('#max-quantity-column').val() < 1 ? 1 : $('#max-quantity-column').val())
        })
