                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama-barang-column" class="form-control" placeholder="Nama Barang" name="nama_barang" value="{{$data->nama_barang}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="deskripsi-column">Deskripsi</label>
                                        <input type="text" id="deskripsi-column" class="form-control" placeholder="Deskripsi" name="description" value="{{$data->description}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="satuan-column" class="form-control" placeholder="Satuan" name="satuan" value="{{$data->satuan}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
