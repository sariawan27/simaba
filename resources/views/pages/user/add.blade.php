                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="no-identity-column" class="form-control" placeholder="Nomor Identitas" name="no_identity">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="name-column">Nama</label>
                                        <input type="text" id="name-column" class="form-control" placeholder="Nama Lengkap" name="nama">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <label>Role</label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="no-telp-column" class="form-control" placeholder="No Telp" name="no_telp">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="address-column">Alamat</label>
                                        <input type="text" id="address-column" class="form-control" placeholder="Alamat" name="alamat">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="data_taruni" class="row" style="display: none;">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nim-column" class="form-control" placeholder="NIM" name="nim">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="angkatan-column">Angkatan</label>
                                        <input type="text" id="angkatan-column" class="form-control" placeholder="Angkatan" name="angkatan">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
